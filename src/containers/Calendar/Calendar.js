...
const DATA = [
  {
    ...
    data: [
      { name: "Ca thứ 7", time: "8:30-17:30", number: "00:00-00:00" },
      { name: "Ca tối", time: "8:30-17:30", number: "00:00-00:00" },
    ],
  },
  {
...
function Item({ data }) {
  return (
    <TouchableOpacity style={styles.item}>
      ...
      >
        <Icon name="subway" size={10} style={{ paddingRight: 10 }} />
  ...
  static navigationOptions = () => ({
    headerTitle: () => (
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
        <Text style={{ color: "white", fontSize: 18 }}>Lịch công</Text>
      </View>
    ),
  });
  constructor() {
